...
call s:IsMatches('Cl', {1: ['Cl', 'ClA', 'Cla', 'Clas', 'Cli']}, 'full-id cc match at start of line')
call s:IsMatches('lala Cl', {6: ['Cl', 'ClA', 'Cla', 'Clas', 'Cli']}, 'full-id cc match space-delimited')
call s:IsMatches('lala|Cl', {6: ['Cl', 'ClA', 'Cla', 'Clas', 'Cli']}, 'full-id cc match nonkeyword-delimited')
